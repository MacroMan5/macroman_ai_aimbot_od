...
then
  C:/Program Files/Microsoft Visual Studio/18/Insiders/MSBuild/Current/Bin/amd64/MSBuild.exe $targets_to_make ${EIGEN_MAKE_ARGS}
else
  C:/Program Files/Microsoft Visual Studio/18/Insiders/MSBuild/Current/Bin/amd64/MSBuild.exe $targets_to_make 
fi
exit $?
