...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "v3.7.0"
  WORKING_DIRECTORY "C:/Users/therouxe/source/repos/marcoman_ai_aimbot/.worktrees/feature-phase3-tracking/build/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/therouxe/source/repos/marcoman_ai_aimbot/.worktrees/feature-phase3-tracking/build/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/therouxe/source/repos/marcoman_ai_aimbot/.worktrees/feature-phase3-tracking/build/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
